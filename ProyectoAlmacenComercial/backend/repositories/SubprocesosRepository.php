...
class SubprocesosRepository
{
    ...
    public function save($data)
    {
        ...
        if (empty($data['id_proy'])) {
            throw new Exception('El id_proy es obligatorio');
        }
        ...
        if (!empty($data['id_tarea']) && $this->findById($data['id_tarea'])) {
            ...
            $numeroSecuencial = $this->obtenerSiguienteNumeroSecuencial();
            
            $query = "
                INSERT INTO proy_subprocesos (
                    id_tarea, id_proy, id_tarea_padre, numero_secuencial, es_tarea_principal, 
